...
interface GridDistortionProps {
  ...
  imageSrc: string;
  className?: string;
  mousePosition?: { x: number; y: number }; // Nhận mouse position từ parent
}
...
const GridDistortion: React.FC<GridDistortionProps> = ({
  ...
  useEffect(() => {
    ...
    // Thêm pointer-events: none cho canvas
